...
// module
exports.push([module.i, ".button[data-v-1fc841db]{margin:5px 0 0}.control .button[data-v-1fc841db]{margin:inherit}.fa-trash-o[data-v-1fc841db]{color:red}.fa-info[data-v-1fc841db]{color:#87cefa}.switch[data-v-1fc841db]{top:7px}", "", {"version":3,"sources":["/data/serverless-cms-admin/client/views/tools/CreateToken.vue"],"names":[],"mappings":"AACA,yBACE,cAAgB,CACjB,AACD,kCACE,cAAgB,CACjB,AACD,6BACE,SAAW,CACZ,AACD,0BACE,aAAoB,CACrB,AACD,yBACE,OAAS,CACV","file":"CreateToken.vue","sourcesContent":["\n.button[data-v-1fc841db] {\n  margin: 5px 0 0;\n}\n.control .button[data-v-1fc841db] {\n  margin: inherit;\n}\n.fa-trash-o[data-v-1fc841db] {\n  color: red;\n}\n.fa-info[data-v-1fc841db] {\n  color: lightskyblue;\n}\n.switch[data-v-1fc841db] {\n  top: 7px;\n}\n\n"],"sourceRoot":""}]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js?sourceMap!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1fc841db\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateToken.vue", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js?sourceMap!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-1fc841db\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CreateToken.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
